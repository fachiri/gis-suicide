			...
			<div class="card shadow-lg">
				...
				<div class="card-body px-4">
					<x-form.layout.horizontal action="{{ route('dashboard.master.perpetrators.update', $perpetrator->uuid) }}" method="PUT" submit-text="Perbarui">
						...
						<x-form.select layout="horizontal" name="gender" label="Jenis Kelamin" :value="$perpetrator->gender" :options="[
						    (object) [
						...
						<x-form.select layout="horizontal" name="education" label="Pendidikan" :value="$perpetrator->education" :options="[
						    (object) [
						        'label' => 'SD',
						        'value' => 'SD',
						    ],
						...
						<x-form.select layout="horizontal" name="marital_status" label="Status Pernikahan" :value="$perpetrator->marital_status" :options="[
						    (object) [
						        'label' => 'Belum Menikah',
						        'value' => 'Belum Menikah',
						    ],
						...
						<x-form.input layout="horizontal" name="occupation" label="Pekerjaan" placeholder="Pekerjaan.." :value="$perpetrator->occupation" />
